...
factor1 <- cbind(pregunta1$Media,pregunta2$Media,pregunta4$Media,pregunta5$Media)
#destreza pedagógica del profesor
factor2 <- cbind(pregunta2$Media,pregunta4$Media)
#entorno
factor3 <- cbind(pregunta3$Media,pregunta6$Media,pregunta7$Media,pregunta8$Media)
cor(factor1)
cor(factor2)
cor(factor3)
